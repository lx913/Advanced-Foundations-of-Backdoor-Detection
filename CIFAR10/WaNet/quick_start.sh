python3 train.py -model resnet -lr_C 0.01 -bs 128 -n_iters 50 -pc 0.1 -cross_ratio 2 -model_num 10 -target_label 0
...
python3 train.py -model senet -lr_C 0.01 -bs 128 -n_iters 50 -pc 0.1 -cross_ratio 2 -model_num 10 -target_label 0
