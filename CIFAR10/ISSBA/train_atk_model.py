...
def create_backdoor_data_loader(dataname, batch_size):
    if dataname == 'cifar10':
        ...
        train_data = torchvision.datasets.CIFAR10(root=args.datapath, train=True, transform=transform, download=True)
        test_data = torchvision.datasets.CIFAR10(root=args.datapath, train=False, transform=transform, download=True)
