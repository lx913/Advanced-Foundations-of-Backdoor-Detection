...
def main():
    ...
    train_data = torchvision.datasets.GTSRB(root='dataset',split="train",download=True)
    test_data = torchvision.datasets.GTSRB(root='dataset',split="test",download=True)
