...
def get_arguments():
    ...
    parser.add_argument("-checkpoints", type=str, default="./save_model")
    ...
    parser.add_argument("-model_num", type=int, default=30) 
    parser.add_argument("-ft_ratio", type=float, default=0.05) 
